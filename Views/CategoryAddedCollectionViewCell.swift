//
//  CategoryAddedCollectionViewCell.swift
//  ExpenseTracker
//
//  Created by Jennifer Chukwuemeka on 27/02/2024.
//

import UIKit
protocol CategoryAddedCollectionViewCellDelegate: AnyObject {
    func deleteButtonTapped(_ cell: CategoryAddedCollectionViewCell)
}

class CategoryAddedCollectionViewCell: UICollectionViewCell {
    static let identifier = "CategoryAddedCollectionViewCell"
    weak var delegate:  CategoryAddedCollectionViewCellDelegate?
    ...
    func configure(with recent: UserExpenseItem) {
        ...
        // Set the date label using the date directly
        let dateFormatter = DateFormatter()
        dateFormatter.dateFormat = "MMM dd, yyyy" // Adjust the display format
...
extension CategoryAddedCollectionViewCell {
